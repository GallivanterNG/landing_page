    ...
    return (
        <div className="mt-24 p-[16px] md:p-[64px] items-center justify-center flex flex-col">
            ...
            <div className="flex mt-24  max-w-[1920px]">
                <div className="w-2/3">
                    <img src="./assets/images/logo.png" alt="" className="mb-6 w-[120px]" />
                    <p>Gallivanter is a dynamic platform designed to connect and empower three distinct user groups within the world of travel and adventure: Tourists, Local Guides, and Tour Agents/Providers.</p>
                </div>
