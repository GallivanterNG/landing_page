      ...
      {/* <div ref={homeRef} className='w-full lg:flex justify-center pt-24'>
        <div className=' lg:flex justify-between max-w-[1920px] '>
          <div className='mr-[16px] lg:ml-[160px] ml-[16px] mt-[64px] lg:mt-[120px] lg:w-1/2 '>
            ...
            <p className='mt-8 text-[40px] lg:text-[62px] text-[#381914] font-extrabold leading-[46px] lg:leading-[68px] lg:w-full'>
            ...
            <p className='text-[#222] mt-6  lg:w-2/3 lg:text-[18px] font-medium lg:leading-[21px] '>
              ...
              guidance, and success in Nigeria.
            </p>
            <div className='bg-[#F76F59] text-white px-6 py-3 rounded-full w-fit mt-12 '
        ...
        <div className='w-full lg:flex justify-between max-w-[1920px] pt-24 lg:pt-32 items-center'>
          <div className='pb-4 pd:mb-0 mx-[16px]  lg:ml-[160px] '>
            ...
            <div className='lg:flex gap-4 mt-8 items-center'>
              ...
              <div className='mt-4'>
                <p className='font-semibold text-[#222] text-[18px] lg:text-[19px]'>{sections.description[0].title}</p>
                <p className='text-[#222] mt-1 leading-5 w-2/3 text-[16px] lg:text-[18px]'>{sections.description[0].description}</p>
              </div>
            </div>
            <div className='lg:flex gap-4 mt-8 items-center'>
              <div className='bg-[#ffdfda] p-2 rounded-lg'>
              ...
              <div className='mt-4'>
                <p className='font-semibold text-[#222] text-[18px] lg:text-[19px]'>{sections.description[1].title}</p>
                <p className='text-[#222] mt-1 leading-5 w-2/3 text-[16px] lg:text-[18px]'>{sections.description[1].description}</p>
              </div>
            </div>
            <div className='lg:flex gap-4 mt-8 items-center mb-40'>
              ...
              <div className='mt-4 '>
                <p className='font-semibold text-[#222] text-[18px] lg:text-[19px] '>{sections.description[2].title}</p>
                <p className='text-[#222] mt-1 leading-5 w-2/3 text-[16px] lg:text-[18px]'>{sections.description[2].description}</p>
              </div>
            </div>
          </div>
          <div className='hidden lg:block'><img src={sections.images[0]} alt="" /></div>
        </div>
      </div>
